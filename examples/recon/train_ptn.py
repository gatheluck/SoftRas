...
parser.add_argument('-cls', '--class_id', type=str, default='02828884')
parser.add_argument('-dpath', '--dataset_path', type=str, default='/home/gatheluck/Scratch/nips16_PTN/data')
...
# dataset 
dataset_train = datasets.PtnShapeNet(
...
def train():
	...
	for i in range(start_iter, args.num_iterations + 1):
		...
		#print("viewpoints_a:", viewpoints_a.shape)
